...
//         {
//           "rel": "alternate",
//           "href": "http://localhost/~joni/00_GIT/images/thumbnails/wsim/wsag/1/wsimagehash*&(&@*&%23*(",
//           "description": null
//         }
//       ]
//     }
...
//         copy.id =  100 + i;
//         copy.user.id = 1000 + i;
//         copy.user.first_name = "Joni" + i;
//         copy.user.last_name = "Aaltonen" + i;
//         $scope.subscriptions.subscriptions.push(copy);        
//       }
        //$scope.totaItems = $scope.subscriptions.total_count;
        //$scope.totaItems = $scope.subscriptions.subscriptions.length;
        //TODO - switch to total_count
        //$scope.totalItems = $scope.subscriptions.subscriptions.length;
